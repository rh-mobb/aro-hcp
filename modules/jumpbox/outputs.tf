...
output "sshuttle_command" {
  value = "sshuttle -r ${var.admin_username}@${azurerm_public_ip.jump.ip_address} --dns -e \"ssh -o StrictHostKeyChecking=accept-new -i ${var.ssh_private_key_path}\" ${var.address_prefix}"
}
