...
Published site: [https://rh-mobb.github.io/validated-pattern-aro-hcp/](https://rh-mobb.github.io/validated-pattern-aro-hcp/) (MkDocs Material, deployed from `main` via GitHub Actions). Local preview: `make docs-preview`.
